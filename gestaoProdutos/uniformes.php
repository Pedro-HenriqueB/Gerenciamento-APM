...
<body>
	<div class="titulo"><h1>Uniformes</h1></div>
	<?php 
	...
	<form method="post" action="uniformes.php">
	...
	<?php foreach($uniformes as $uniforme) { ?>
		...
		<div class="nomes"><?php echo $uniforme[0]; //input para inserir as quantidades para dar baixa ?></div>
		<div class="inputs"><input type="number" id="<?=$uniforme[0]?>" name="<?=$uniforme[0]?>"></div>
